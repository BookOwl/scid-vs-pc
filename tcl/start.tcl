...
set scidVersionDate {Mar 25, 2014}
...
set default_exportStartFile(LaTeX_Skak) {\documentclass[10pt,twocolumn,twoside,DIV=20]{scrreprt}
  % This is a LaTeX file generated by Scid.
...
set default_exportEndFile(LaTeX_Skak) {\end{document}
}
