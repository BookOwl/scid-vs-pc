...
#
# (4) Προαιρετικά, δημιουργούμε νέα μηνύματα βοήθειας ως εξής:
#
#     set helpTitle(G,Contents) "Περιεχόμενα"
#     set helpText(G,Contents) {<h1>Περιεχόμενα Βοήθειας Scid</h1>
...
menuText G FileMaint "Συντήρηση" 0 {Εργαλεία συντήρησης βάσεων δεδομένων}
...
menuText G FileMaintClass "Προσθήκη ECO στις Παρτίδες" 1 \
  {Επανυπολογισμός ECO για όλες τις παρτίδες}
menuText G FileMaintSort "Ταξινόμηση Βάσης Δεδομένων" 2 \
  {Ταξινομήση παρτίδων βάσης δεδομένων}
menuText G FileMaintDelete "Διαγραφή Διπλών Παρτίδων" 0 \
  {Εύρεση διπλών παρτίδων και επιλογή τους προς διαγραφή}
menuText G FileMaintTwin "Παράθυρο Ελέγχου Διπλών Παρτίδων" 9 \
  {Άνοιγμα/ενημέρωση παραθύρου Ελέγχου διπλών παρτίδων}
menuText G FileMaintName "Συλλαβισμός Ονομάτων" 12 {Εργαλεία επεξεργασίας Ονομάτος και συλλαβισμού}
menuText G FileMaintNameEditor "Επεξεργαστής Ονομάτων" 3 \
  {Άνοιγμα/κλείσιμο του παραθύρου Επεξεργαστή Ονομάτων}
menuText G FileMaintNamePlayer "Συλλαβισμός Ονομάτων Παικτών" 21 \
  {Έλεγχος Ονομάτων παικτών με την χρήση σχετικού αρχείου παικτών}
menuText G FileMaintNameEvent "Συλλαβισμός Ονομάτων Διοργανώσεων" 21 \
  {Έλεγχος ονομάτων διοργανώσεων με την χρήση σχετικού αρχείου}
menuText G FileMaintNameSite "Συλλαβισμός Ονομάτων Τοποθεσιών" 21 \
  {Έλεγχος ονομάτων τοποθεσιών με την χρήση σχετικού αρχείου τοποθεσιών}
menuText G FileMaintNameRound "Έλεγχος Γύρων Αγώνων" 8 \
...
menuText G FileMaintFixBase "Επιδιόρθωση Βάσης Δεδομένων" 7 {Προσπάθεια επιδιόρθωσης χαλασμένης Βάσης Δεδομένων}
...
menuText G ToolsOpenBaseAsTree "Άνοιγμα Βάσης ως Δένδρο" 8   {Άνοιγμα Βάσης και χρησιμοποίησή της στο παράθυρο Δένδρο Κινήσεων}
menuText G ToolsOpenRecentBaseAsTree "Άνοιγμα Πρόσφατης ως Δένδρο" 8   {Άνοιγμα πρόσφατης Βάσης και χρησιμοποίησή της στο παράθυρο Δένδρο Κινήσεων}
